<x-layouts.app title="Dashboard">
    <div
        class="shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] w-[600px] mx-auto mt-6 rounded-md relative bg-cover bg-no-repeat bg-top">
        <div class="absolute inset-0 bg-gradient-to-b from-blue-500 to-white opacity-10"></div>

        <div class="relative z-10">
            <header class="flex items-center justify-between p-6">
                <h1 class="flex items-center gap-1.5 font-semibold text-lg">
                    <x-heroicon-o-light-bulb class="w-4.5 h-4.5 text-blue-600" />
                    Ampol Ai
                </h1>

                <div class="flex items-center gap-2">
                    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-[29px] h-[29px]">
                    ...
                    <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" class="w-6 h-6">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
            ...
            <div class="mt-10 flex flex-col items-center justify-center text-center">
                <svg height="200px" width="200px" version="1.1" id="_x36_" xmlns="http://www.w3.org/2000/svg"
                ...
                <h1 class="text-2xl">Verify your email address</h1>
                <p class="w-[500px]">
                    Thank you for joining us! To complete your registration and start using your account, please verify
                    your email address by clicking the button below:
                </p>

                <button class="mt-7 py-2.5 px-8 bg-blue-500 rounded-md text-white">Verify Now</button>

                <div class="w-[500px] text-left">

                    <p class=" mt-14 ">If the button above doesn't work, you can copy and paste the
                        following link
                        into your browser:</p>
                    <a href="/" class="text-blue-500">http://google.com/hl0loworldlsdfdweriowuepweirjiwiokd</a>
                </div>
            </div>

            <footer class="mt-16 p-6 relative flex flex-col items-center justify-center">
                <div class="absolute inset-0 bg-blue-300 to-white opacity-10"></div>

                <p>Please share your feedbacks or contact me
                    <a href="https://www.linkedin.com/in/eyosiyas-abay/" target="_blank"
                        class="text-blue-500">here</a>.
                </p>
                <p class="text-gray-500">@2025 Ampol</p>
            </footer>
        </div>
    </div>
</x-layouts.app>
